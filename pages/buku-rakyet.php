    ...
    <main class="container clear"> 
      ...
      <div id="content" class="three_quarter first"> 
        ...
        <ul class="nospace listing">
          <h1>Buku CERPEN</h1>
            <li class="clear">
              <div class="imgl borderedbox"><img src="../images2/Untitled design (55).png" alt=""></div>
              <p class="nospace btmspace-15"><a href="#">Aku Ingin Sekolah, Kisah Anak Suku Sakai</a></p>
              <p><a href="http://www.os-templates.com/"></a>Download</p>
              <br><font size="1">02/01/2021 15:10 - Oleh Administrator - Dilihat 702 kali</font>
            </li>
          </ul>
    </div>
        <!-- ################################################################################################ --> 
