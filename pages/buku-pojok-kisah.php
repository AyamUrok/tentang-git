    ...
    <main class="container clear"> 
      ...
      <div id="content" class="three_quarter first"> 
        ...
        <ul class="nospace listing">
          <h1>POJOK KISAH</h1>
            <li class="clear">
              <div class="imgl borderedbox"><img src="../images2/Untitled design (56).png" alt=""></div>
              <p class="nospace btmspace-15"><a href="#">Jejak Penjaga Zaman</a></p>
              <p><a href="http://www.os-templates.com/"></a>Download</p>
              <br><font size="1">25/02/2021 11:00 - Oleh Administrator - Dilihat 596 kali</font>
            </li>
            <li class="clear">
              <div class="imgl borderedbox"><img src="../images2/Untitled design (57).png" alt=""></div>
              <p class="nospace btmspace-15"><a href="#">Pojok Kisah, Karya Defanza Ghifari</a></p>
              <p>Dwi Safrianti; Sendiri di tengah Pandemi   Dwi Safrianti akrab disapa Dwi, ialah seorang perempuan berusia 45 tahun. Ia berprofesi sebagai wanita karier, hingga</p>
              <br><font size="1">11/08/2020 18:00 - Oleh Administrator - Dilihat 1229 kali</font>
            </li>
            <li class="clear">
                <div class="imgl borderedbox"><img src="../images2/Untitled design (58).png" alt=""></div>
                <p class="nospace btmspace-15"><a href="#">Pojok Kisah, Karya Yasmin Fathia</a></p>
                <p>Kisah Pengemudi Truk di Ibukota   Terlihat waktu sudah menunjukkan pukul 15:00 sore. Pak Aris seorang supir truk menceritakan kehidupan keluarganya.  Pak A</p>
                <br><font size="1">09/08/2020 16:00 - Oleh Administrator - Dilihat 1185 kali</font>
              </li>
              <li class="clear">
                <div class="imgl borderedbox"><img src="../images2/Untitled design (59).png" alt=""></div>
                <p class="nospace btmspace-15"><a href="#">Pojok Kisah, Karya Niya Annisai</a></p>
                <p>Kisah Arbaiah ; Penjual Nasi Uduk   Kisahnya dimulai semenjak ia nekat merantau dari kampung halamannya di Babakan, Gunung Sari, Serang , Jawa barat pada tahun</p>
                <br><font size="1">08/08/2020 21:30 - Oleh Administrator - Dilihat 748 kali</font>
              </li>
