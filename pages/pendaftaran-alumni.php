  ...
  <div class="rounded">
    ...
    <form action="proses_pendaftaran.php" method="post" enctype="multipart/form-data" class="form-container">
        ...
        <div class="form-row">
            ...
            <input type="number" name="tahun_lulus" id="tahun_lulus" class="form-input" required>
        </div>
        <div class="form-row">
            <label for="nis" class "form-label">NIS</label>
            <input type="text" name="nis" id="nis" class="form-input">
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <input type="text" name="handphone" id="handphone" class="form-input">
        </div>
        <div class="form-row">
