  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div id="content" class="three_quarter first"> 
        ...
        <div class="left-box">
      <h2>Visi dan Misi</h2>
      <p>Visi: Memiliki tamatan yang Berbudi pekerti luhur, Berkarakter, Mandiri, Berprestasi dan Berjiwa Wirausaha <br><br><br></p>
      <p>Misi:<br> 1. Mengimplementasikan 5S (Senyum, Sapa, Salam, Sopan dan Santun).<br>
        2. Membangun peserta didik menjadi seseorang yang memiliki sikap profesional.<br>
        3. Mengarahkan peserta didik untuk meningkatkan potensi dan keahlian diri melalui pelatihan di dalam maupun di luar lingkungan sekolah<br>
        4. Menyiapkan tamatan agar mendapatkan prestasi juara di tingkat nasional dengan pelatihan di setiap kompetensi.<br>
        5. Mengarahkan peserta didik mempunyai jiwa wirausaha melalui pelajaran kewirausahaan.<br></p>
    </div>
        <!-- ################################################################################################ --> 
      </div>
      <!-- ################################################################################################ --> 
