...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading">FOTO - FOTO SMK NEGERI 64 JAKARTA</header>
          <ul class="nospace clear">
            <li class="one_quarter first"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (31).png" title="Display Text 1"><img class="borderedbox" src="../images3/Untitled design (31).png" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (32).png" title="Display Text 2"><img class="borderedbox" src="../images3/Untitled design (32).png" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (33).png" title="Display Text 3"><img class="borderedbox" src="../images3/Untitled design (33).png" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (34).png" title="Display Text 4"><img class="borderedbox" src="../images3/Untitled design (34).png" alt=""></a></li>
            <li class="one_quarter first"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (35).png" title="Display Text 5"><img class="borderedbox" src="../images3/Untitled design (35).png" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (36).png" title="Display Text 6"><img class="borderedbox" src="../images3/Untitled design (36).png" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (37).png" title="Display Text 7"><img class="borderedbox" src="../images3/Untitled design (37).png" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (38).png" title="Display Text 8"><img class="borderedbox" src="../images3/Untitled design (38).png" alt=""></a></li>
            <li class="one_quarter first"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (39).png" title="Display Text 9"><img class="borderedbox" src="../images3/Untitled design (39).png" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (40).png" title="Display Text 10"><img class="borderedbox" src="../images3/Untitled design (40).png" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (41).png" title="Display Text 11"><img class="borderedbox" src="../images3/Untitled design (41).png" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="../images3/Untitled design (42).png" title="Display Text 12"><img class="borderedbox" src="../images3/Untitled design (42).png" alt=""></a></li>
          </ul>
      ...
      <nav class="pagination">
        <ul>
          ...
          <li><a href="#">6</a></li>
          <li><a href="#">7</a></li>
          <li class="current"><strong>8</strong></li>
          <li><a href="#">9</a></li>
          <li><strong>&hellip;</strong></li>
          <li><a href="#">14</a></li>
          <li><a href="#">15</a></li>
