      ...
      <div id="portfolio">
        <ul class="nospace clear">
          <li class="one_half first">
            <article><img class="borderedbox" src="../images3/Untitled design (43).png" alt="">
              
            </article>
          </li>
          <li class="one_half">
            <article><img class="borderedbox" src="../images3/Untitled design (44).png" alt="">
              
            </article>
          </li>
          <li class="one_half first">
            <article><img class="borderedbox" src="../images3/Untitled design (45).png" alt="">
              
            </article>
          </li>
          <li class="one_half">
            <article><img class="borderedbox" src="../images3/Untitled design (46).png" alt="">
              
            </article>
          </li>
          <li class="one_half first">
            <article><img class="borderedbox" a hraf ="https://www.youtube.com/watch?v=pHx6vwLm9sY" src="../images3/Untitled design (47).png" alt="">
              
            </article>
          </li>
          <li class="one_half">
            <article><img class="borderedbox" src="../images3/Untitled design (48).png" alt="">
