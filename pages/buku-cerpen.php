    ...
    <main class="container clear"> 
      ...
      <div id="content" class="three_quarter first"> 
        ...
        <ul class="nospace listing">
          <h1>Buku CERPEN</h1>
            <li class="clear">
              <div class="imgl borderedbox"><img src="../images2/Untitled design (51).png" alt=""></div>
              <p class="nospace btmspace-15"><a href="#">Habis Galau Terbitlah Gemilang</a></p>
              <p><a href="http://www.os-templates.com/"></a>Download</p>
              <br><font size="1">02/02/2021 19:35 - Oleh Administrator - Dilihat 691 kali</font>
            </li>
            <li class="clear">
              <div class="imgl borderedbox"><img src="../images2/Untitled design (52).png" alt=""></div>
              <p class="nospace btmspace-15"><a href="#">Mutiara Yang Kau Genggamm</a></p>
              <p>Download</p>
              <br><font size="1">202/02/2021 11:00 - Oleh Administrator - Dilihat 747 kali</font>
            </li>
            <li class="clear">
                <div class="imgl borderedbox"><img src="../images2/Untitled design (53).png" alt=""></div>
                <p class="nospace btmspace-15"><a href="#">Jalan Panjang Meraih CIta</a></p>
                <p>Download</p>
                <br><font size="1">202/01/2021 19:55 - Oleh Administrator - Dilihat 603 kali</font>
              </li>
              <li class="clear">
                <div class="imgl borderedbox"><img src="../images2/Untitled design (54).png" alt=""></div>
                <p class="nospace btmspace-15"><a href="#">Pagi dan Kita Bertemu Lagi</a></p>
                <p>  Oleh Ayu Rahayu Malam ini malam tahun baru, berbeda dari tahun-tahun sebelumnya. Aku menepikan diri di pedesaan, yang memang jauh dengan hingar bingar.</p>
                <br><font size="1">01/01/2021 07:00 - Oleh Administrator - Dilihat 675 kali</font>
              </li>
