    ...
    <main class="container clear"> 
      ...
      <div id="content" class="three_quarter first"> 
        ...
        <ul class="nospace listing">
          <h1>TEPIAN SAJAK</h1>
            <li class="clear">
              <div class="imgl borderedbox"><img src="../images2/Untitled design (60).png" alt=""></div>
              <p class="nospace btmspace-15"><a href="#">Tepian pejuang wanita</a></p>
              <p><a href="http://www.os-templates.com/"></a> Wanita asa buana   Terlahir sebagai wanita jatmika nan anindya Memberikan sinar harsa bagi mereka Keberanian yang tak pernah hirap Seolah menjadi benteng untuk</p>
              <br><font size="1">21/04/2021 12:55 - Oleh Administrator - Dilihat 634 kali</font>
            </li>
